...
public class ModuleFileRepository extends FileRepository {
    ...
    public List<SectionData> getSections() {
        ...
        return Arrays.stream(BookLoader.GSON.fromJson(this.resourceToString(this.getResource(this.getResourceLocation("index.json"))), SectionDataModule[].class)).filter((section) -> section.module.isEmpty() || this.manager.test(section.module)).collect(Collectors.toList());
    }
